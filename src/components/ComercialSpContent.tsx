...
import { useComercialSpGeral } from "@/hooks/useComercialSpGeral";
import { useComercialSpDiario } from "@/hooks/useComercialSpDiario";
import { STATUS_LABELS, STATUS_COLORS, DiarioStatus } from "@/services/comercialSpDiarioService";
...
import ComercialSpDiarioExportModal from "./ComercialSpDiarioExportModal";
...
const ComercialSpContent = () => {
  const { data: geral, isLoading: loadingG } = useComercialSpGeral();
  const { data: diario, isLoading: loadingD } = useComercialSpDiario();
  ...
  // Helpers para extrair mês de uma data "DD/MM/YYYY"
...
export default ComercialSpContent;
